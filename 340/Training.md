...
Training can look very different for [[Parametric Models]] and [[Non-Parametric Models]]. For example, in [[KNN]], a type of [[Supervised Learning]], training is only the storage of [[Training]] Data.
