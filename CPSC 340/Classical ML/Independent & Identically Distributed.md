...
- Independence
	- Our data points are not dependent on each other
	- ie: example 1 has no effect on example 2. 
- Identically Distributed
	- Our data is a random sample that is taken from the full domain of the feature space